...
class _HomePageState extends State<HomePage> {
  ...
  bool loading = false;
  final server_url = "http://192.168.43.133:8000";  //change your URL or local IP
  ...
  void solveCube(_context) async {
    ...
    try {
      ...
      if (response.data["status"] == false) {
        ...
        print(responser.data);
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => SolveCube(cubeString: cubeString,)));
      }
    } catch (e) {
      setState(() {
        loading = false;
